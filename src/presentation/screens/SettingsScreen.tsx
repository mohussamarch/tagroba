  ...
  return (
    <div className="settings">
      ...
      <section className="card" aria-label="التصدير والنسخ الاحتياطي">
        ...
        <p className="settings__hint">
          نسخة بيانات الحساب تشمل العمليات والمصادر والمحافظ والتصنيفات والأشخاص والديون والاستثمارات والوسوم والاشتراكات والميزانيات وملف الحساب، مع بصمة لفحص سلامة الملف.
